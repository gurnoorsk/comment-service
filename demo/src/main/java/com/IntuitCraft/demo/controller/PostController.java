...
public class PostController {
    ...
    @Operation(summary = "delete a post",tags = "Posts",description = "Delete a existing post")
    public CommonResponse<Post> deletePost(@Parameter(description = "Post id") @PathVariable("postId") Long postId,@RequestBody String userId){
        return new CommonResponse<Post>(HttpStatus.OK.value(),
                RequestMethod.DELETE.toString(), UUID.randomUUID().toString()
